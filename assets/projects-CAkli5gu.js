import"./loader-C5IFBMMi.js";import{i as c,p as r}from"./apply-theme-BFTDiRWQ.js";let a="All";const l=t=>a==="All"?t:t.filter(n=>n.category===a),o=t=>{const n=t.status==="WIP"?" project-entry__status--wip":"",e=t.tags.map(s=>`<li>${s}</li>`).join("");return`
