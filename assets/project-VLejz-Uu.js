import"./loader-bCRQtbAi.js";import{p as g,i as x}from"./apply-theme-Ce-kM_Nc.js";let n=null,c=0,s=[],p=null,m=!1;const d=()=>(n instanceof HTMLElement||(n=document.createElement("div"),n.className="gallery-lightbox",n.id="gallery-lightbox",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.setAttribute("aria-label","Image gallery"),n.setAttribute("aria-hidden","true"),n.hidden=!0,n.innerHTML=`
  ...
  `,document.title="Not Found — Projects"},S=(e,t)=>{var o;document.title=`${t.title} — Projects`;const a=t.status==="WIP"?" project-detail__status--wip":"",l=t.tags.map(r=>`<li>${r}</li>`).join(""),u=t.externalUrl?`<a
    ...
    ${T(i.images)}
    ${A(t.notes)}
  `,e.querySelectorAll("video").forEach(r=>{H(r)}),(o=i.images)!=null&&o.length&&v(e,i.images)},w=()=>{const e=document.getElementById("project-detail"),t=k();if(!(e instanceof HTMLElement))return;const a=t?j(t):void 0,l=(a==null?void 0:a.theme)??g.defaultTheme;if(x(g.themes,l,g.defaultTheme),!t){b(e);return}if(!a){b(e);return}S(e,a)};document.addEventListener("DOMContentLoaded",w);
